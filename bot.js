...
// Twitch Client Key (TWITCH_KEY)
const CLIENT_ID = process.env.live_410771733_UaH7CoOQlJJB8fLRC270iVjcM3qoaB;

// Your Discord server ID
const SERVER_ID = "741831539263930431";

// The ID of the channel INSIDE of your Discord server that you want welcome messages sent to
const CHANNEL_ID = "741831539893207052";

// $MEMBER pings the user
const WELCOME_MSG =
  ":tada: Fuck you $MEMBER :tada:";

// The ID of the role automatically assigned to a user when they join your server (maybe I'll put this in later)
const ROLE_ID = "";
